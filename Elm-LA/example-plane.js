...
var $author$project$ExamplePlane$init = function (_v0) {
...
var $author$project$ExamplePlane$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$ExamplePlane$subscriptions = function (_v0) {
	return A2($elm$time$Time$every, 30, $author$project$ExamplePlane$Tick);
};
var $author$project$ExamplePlane$update = F2(
	function (msg, model) {
...
var $author$project$Space$Plane = F3(
	function (a, b, c) {
...
var $author$project$Space$shift = F2(
	function (params, pt) {
		...
		var offsetY = space * params.sceneOrigin.y;
		var offsetX = space * params.sceneOrigin.x;
		var drawPt = A2(
		...
		return A2($author$project$Utils$Point2D, (drawPt.x * space) + offsetX, ((-drawPt.y) * space) + offsetY);
	});
...
var $author$project$Space$drawPlane = F4(
	function (params, pln, hasHatch, color) {
		var zVal = F2(
			function (x, y) {
		...
		return _Utils_ap(
			_List_fromArray(
				[poly]),
			hasHatch ? _Utils_ap(xlines, ylines) : _List_Nil);
	});
var $elm$svg$Svg$Attributes$strokeDasharray = _VirtualDom_attribute('stroke-dasharray');
var $author$project$Space$drawPoint = F3(
	function (params, pt, color) {
...
var $author$project$Space$drawElement = F2(
	function (params, e) {
		if (e.$ === 'Plane') {
			...
			var hasHatch = e.b;
			var color = e.c;
			return A4($author$project$Space$drawPlane, params, pln, hasHatch, color);
		} else {
			var pt = e.a;
			var color = e.b;
			return A3($author$project$Space$drawPoint, params, pt, color);
		}
	});
...
var $author$project$ExamplePlane$view = function (model) {
	var pln = A4($author$project$Utils$Plane3D, 1, 1, 1, 1);
	var p3 = A3($author$project$Utils$Point3D, -8, 8, 1);
	var p2 = A3($author$project$Utils$Point3D, -3, -5, 9);
	var p1 = A3($author$project$Utils$Point3D, 4, 3, -6);
	return A2(
		$author$project$Space$basic3D,
		model,
		_List_fromArray(
			[
				A3($author$project$Space$Plane, pln, true, $author$project$Utils$Red),
				A2($author$project$Space$Point, p1, $author$project$Utils$Red),
				A2($author$project$Space$Point, p2, $author$project$Utils$Red),
				A2($author$project$Space$Point, p3, $author$project$Utils$Red)
			]));
};
var $author$project$ExamplePlane$main = $elm$browser$Browser$element(
	{init: $author$project$ExamplePlane$init, subscriptions: $author$project$ExamplePlane$subscriptions, update: $author$project$ExamplePlane$update, view: $author$project$ExamplePlane$view});
_Platform_export({'ExamplePlane':{'init':$author$project$ExamplePlane$main(
