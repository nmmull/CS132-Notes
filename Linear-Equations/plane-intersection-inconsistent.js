...
var $author$project$PlaneIntersectionInconsistent$init = function (_v0) {
...
var $author$project$PlaneIntersectionInconsistent$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$PlaneIntersectionInconsistent$subscriptions = function (_v0) {
	return A2($elm$time$Time$every, 30, $author$project$PlaneIntersectionInconsistent$Tick);
};
var $author$project$PlaneIntersectionInconsistent$update = F2(
	function (msg, model) {
...
var $author$project$Space$getInterByY = F4(
	function (params, pln1, pln2, yVal) {
		var swap = function (_v0) {
			...
			var y = _v0.y;
			var z = _v0.z;
			return A3($author$project$Utils$Point3D, y, x, z);
		};
...
var $author$project$PlaneIntersectionInconsistent$view = function (model) {
	var pln3 = A4($author$project$Utils$Plane3D, 0, 0, 1, -2);
	var pln2 = A4($author$project$Utils$Plane3D, 1, 0, -1, -2);
	var pln1 = A4($author$project$Utils$Plane3D, 1, 0, 1, 2);
	return A2(
...
var $author$project$PlaneIntersectionInconsistent$main = $elm$browser$Browser$element(
	{init: $author$project$PlaneIntersectionInconsistent$init, subscriptions: $author$project$PlaneIntersectionInconsistent$subscriptions, update: $author$project$PlaneIntersectionInconsistent$update, view: $author$project$PlaneIntersectionInconsistent$view});
_Platform_export({'PlaneIntersectionInconsistent':{'init':$author$project$PlaneIntersectionInconsistent$main(
