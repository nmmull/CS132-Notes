...
var $author$project$PlaneIntersectionTwo$init = function (_v0) {
...
var $author$project$PlaneIntersectionTwo$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$PlaneIntersectionTwo$subscriptions = function (_v0) {
	return A2($elm$time$Time$every, 30, $author$project$PlaneIntersectionTwo$Tick);
};
var $author$project$PlaneIntersectionTwo$update = F2(
	function (msg, model) {
...
var $author$project$PlaneIntersectionTwo$view = function (model) {
	var pnt2 = A3($author$project$Utils$Point3D, 2, -5.5, -1.5);
	var pnt1 = A3($author$project$Utils$Point3D, 2, 5, 2);
	var pln2 = A4($author$project$Utils$Plane3D, 1, -1, 3, 3);
	var pln1 = A4($author$project$Utils$Plane3D, 2, 1, -3, 3);
	return A2(
...
var $author$project$PlaneIntersectionTwo$main = $elm$browser$Browser$element(
	{init: $author$project$PlaneIntersectionTwo$init, subscriptions: $author$project$PlaneIntersectionTwo$subscriptions, update: $author$project$PlaneIntersectionTwo$update, view: $author$project$PlaneIntersectionTwo$view});
_Platform_export({'PlaneIntersectionTwo':{'init':$author$project$PlaneIntersectionTwo$main(
