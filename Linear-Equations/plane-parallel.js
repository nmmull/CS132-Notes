...
var $author$project$PlaneParallel$init = function (_v0) {
...
var $author$project$PlaneParallel$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$PlaneParallel$subscriptions = function (_v0) {
	return A2($elm$time$Time$every, 30, $author$project$PlaneParallel$Tick);
};
var $author$project$PlaneParallel$update = F2(
	function (msg, model) {
...
var $author$project$PlaneParallel$view = function (model) {
	var pln2 = A4($author$project$Utils$Plane3D, 1, 1, 2, 6);
	var pln1 = A4($author$project$Utils$Plane3D, 1, 1, 2, -3);
	return A2(
		...
		_List_fromArray(
			[
				...
				pln1,
				{color: $author$project$Utils$Red, hasHatch: true}),
				A2(
				$author$project$Space$Plane,
				pln2,
				{color: $author$project$Utils$Blue, hasHatch: true})
			]));
};
var $author$project$PlaneParallel$main = $elm$browser$Browser$element(
	{init: $author$project$PlaneParallel$init, subscriptions: $author$project$PlaneParallel$subscriptions, update: $author$project$PlaneParallel$update, view: $author$project$PlaneParallel$view});
_Platform_export({'PlaneParallel':{'init':$author$project$PlaneParallel$main(
